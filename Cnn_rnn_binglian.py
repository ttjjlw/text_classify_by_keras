...
LEARN_RATE = 0.001
FILTER_SIZE=3
model_name='Cnn_rnn_binglian/'
WEIGHTS_PATH = "save_model/Cnn_rnn_binglian/29_19_35_False_orderly_post_weights_best.h5"  # 载入模型时用，注意每次手动更新加载最优模型
...
if MODE=='train':
    ...
    method_set=['orderly','shuffle','reverse']
    truncat=['pre','post']
    result=[]
